...
export default function ContactSection() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: t("email"),
      details: "info@aurasmilestudio.com",
    },
  ]
    ...
    <section id="contact" className="section-padding bg-gray-50" ref={ref}>
      <div className="container mx-auto container-padding">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[rgb(var(--primary))]">{t("contactTitle")}</h2>
          <p className="text-xl text-gray-600">{t("contactSubtitle")}</p>
        </div>

        <div className="grid md:grid-cols-2 gap-12">
          <div className={inView ? "animate-fade-in" : "opacity-0"}>
            <p className="text-gray-700 mb-8">{t("contactDescription")}</p>
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-[rgb(var(--secondary))]">{item.title}</h3>
            ...
            <div className="mt-8 flex space-x-4">
              <a href="#" className="text-[rgb(var(--primary))] hover:text-[rgb(var(--primary))]/80">
